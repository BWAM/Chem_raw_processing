...
input.path <- file.path(root.dir, "data_input", "2019", "wallkill")
output.path <- file.path(root.dir, "data_output", "2019", "wallkill")
output.filename <- "2019_Wallkill_chem_preqaqc_2019-12-17.csv"
...
sites.master <- read.csv(file.path(root.dir, "data_input/site_tables/20191204_Site_Field.csv"))
