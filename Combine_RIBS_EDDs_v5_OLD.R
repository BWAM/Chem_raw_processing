...
####### Define input/output directories  #########
  ...
  input_dir <- "C:/Data/RIBS/Chem_raw_processing/data_input/2018/FingerLakes/"
  ouput_dir <- "C:/Data/RIBS/Chem_raw_processing/data_output/"
...
# write.table(RIBSdata, file="Combine_EDDs_output3.csv",sep=",", row.names = FALSE)
