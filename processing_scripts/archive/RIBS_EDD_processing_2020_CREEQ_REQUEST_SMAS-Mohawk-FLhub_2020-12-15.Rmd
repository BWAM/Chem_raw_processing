...
input.path <- file.path(root.dir, "data_input", "2020", "CREEQsurvey_chem_all_smas_mohawk_flhub")
output.path <- file.path(root.dir, "data_output", "2020", "CREEQsurvey_chem_all_smas_mohawk_flhub")

output.filename <- paste0("2020_chem_preqaqc_ALL-smas_mohawk_flhub_", Sys.Date(), ".csv")
output.sample.filename <- paste0("2020_chem_preqaqc_SAMPLE-smas_mohawk_flhub__", Sys.Date(), ".csv")
output.result.filename <- paste0("2020_chem_preqaqc_RESULT-smas_mohawk_flhub_", Sys.Date(), ".csv")
output.batch.filename <- paste0("2020_chem_preqaqc_BATCH-smas_mohawk_flhub_", Sys.Date(), ".csv")
