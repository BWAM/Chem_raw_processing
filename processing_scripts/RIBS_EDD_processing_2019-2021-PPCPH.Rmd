...
# Export pre-joined tables (for data analysis)
write.csv(RIBSdata.meth_eval, file.path("C:/Users/gmlemley/New York State Office of Information Technology Services/BWAM - CECs/data/ppcp", "methods_eval_ppcp_results_2021.csv"),row.names = FALSE)
