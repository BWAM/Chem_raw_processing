...
output.filename <- paste0("2019_chem_preqaqc_ALL-SBU_Mohawk_complete_", Sys.Date(), ".csv")
output.sample.filename <- paste0("2019_chem_preqaqc_SAMPLE-SBU_Mohawk_complete_", Sys.Date(), ".csv")
output.result.filename <- paste0("2019_chem_preqaqc_RESULT-SBU_Mohawk_complete_", Sys.Date(), ".csv")
output.batch.filename <- paste0("2019_chem_preqaqc_BATCH-SBU_Mohawk_complete_", Sys.Date(), ".csv")
