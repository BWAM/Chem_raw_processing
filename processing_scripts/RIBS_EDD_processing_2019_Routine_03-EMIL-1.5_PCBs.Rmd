...
input.path <- file.path(root.dir, "data_input", "2019", "routine_pcbs")
output.path <- file.path(root.dir, "data_output", "2019", "routine_pcbs")

output.filename <- paste0("2019_chem_preqaqc_SAMPLE-RESULT_EMIL_PCBs_", Sys.Date(), ".csv")
output.sample.filename <- paste0("2019_chem_preqaqc_SAMPLE-EMIL_PCBs_", Sys.Date(), ".csv")
output.result.filename <- paste0("2019_chem_preqaqc_RESULT-EMIL_PCBs_", Sys.Date(), ".csv")
output.batch.filename <- paste0("2019_chem_preqaqc_BATCH-EMIL_PCBs_", Sys.Date(), ".csv")
