...
proj_name <- "all_subset_assmnts"    # use only lowercase with underscores as spaces"
...
sites.master <- bind_rows(sites.routine, sites.2021)

```

```{r 2020 EDD completeness check}
...
RIBSdata.ALL_corr <- RIBSdata.ALL %>% 
  mutate(SITE_ID_corr = case_when(
    SITE_ID == '12-CANW-7.0' ~ '12-CANW-7.0',
    SITE_ID == '12-CAJO-5.1' ~ '12-CAJO-5.1',
    SITE_ID == '12-CANE-0.5' ~ '12-CANE-0.5',
    SITE_ID == '12-CANW-7.0' ~ '12-CANW-7.0',
    SITE_ID == '12-CAYA-4.7' ~ '12-CAYA-4.7',
    SITE_ID == '12-LASH-0.1' ~ '12-LASH-0.1',
    SITE_ID == '12-ORSK-0.9' ~ '12-ORSK-0.9',
    SITE_ID == '12-POEN-2.0' ~ '12-POEN-2.0',
    SITE_ID == '12-SAUQ-1.7' ~ '12-SAUQ-1.7',
    SITE_ID == '12-SCHO-1.2' ~ '12-SCHO-1.2',
    SITE_ID == '12-STLE-0.2' ~ '12-STLE-0.2',
    SITE_ID == '00-QAQC-0.0' ~ '00-QAQC-0.0',
    SITE_ID == '12-CARO-0.3' ~ '12-CARO-0.3',
    SITE_ID == '12-FULM-0.4' ~ '12-FULM-0.4',
    SITE_ID == '12-REAL-0.1' ~ '12-REAL-0.1',
    SITE_ID == '12-NMIL-0.5' ~ '12-NMIL-0.5',
    SITE_ID == '10-SARA-0.4' ~ '10-SARA-0.3',
    SITE_ID == '13-ROND-9.9' ~ '13-ROND-9.2',
    SITE_ID == '17-KENF_Ta_0.2-04212021' ~ '17-KENF_Ta_0.2-04212021',
    SITE_ID == '12-MOHK-13.4' ~ '12-MOHK-13.4',
    SITE_ID == '12-MOHK-17.3' ~ '12-MOHK-17.3',
    SITE_ID == '12-MOHK-24.0' ~ '12-MOHK-24.0',
    SITE_ID == '12-SCHO-0.6' ~ '12-SCHO-0.6',
    SITE_ID == '11-UHUD-2.7' ~ '11-UHUD-2.7',
    SITE_ID == '13-WALK-19.0' ~ '13-WALK-19.0',
    SITE_ID == '07-AMBER-0.2' ~ '07-AMBER-0.2',
    SITE_ID == '09-BRND-2.5' ~ '09-BRND-2.5',
    SITE_ID == '09-COLE-2.9' ~ '09-COLE-2.9',
    SITE_ID == '09-COLE-4.6' ~ '09-COLE-4.6',
    SITE_ID == '01-RHCR-0.8' ~ '01-RHCR-0.8',
    SITE_ID == '07-KDIG_Tb-a7' ~ '07-KDIG_Tb-a7',
    SITE_ID == '07-LRNC_42-56.7' ~ '07-LRNC_42-56.7',
    SITE_ID == '07COWA-5.0-07202021' ~ '07COWA-5.0-07202021',
    SITE_ID == '07-CANO-2.3' ~ '07-CANO-2.3',
    SITE_ID == '07-DEAN-0.1' ~ '07-DEAN-0.1',
    SITE_ID == '07-FISC-0.1' ~ '07-FISC-0.1',
    SITE_ID == '07-VENS-1.8' ~ '07-VENS-1.8',
    SITE_ID == '11-CALA-1.0' ~ '11-CALA-1.0',
    SITE_ID == '11-XHR-296.0' ~ '11-XHR-296.0',
    SITE_ID == '11-XHR-286.6' ~ '11-XHR-286.6',
    SITE_ID == '17-KENF_Ta-0.2' ~ '17-KENF_Ta-0.2',
    SITE_ID == '07-POTT-0.7' ~ '07-POTT-0.7',
    SITE_ID == '07-LIME-13.0' ~ '07-LIME-13.0',
    SITE_ID == '07-SRAG-8.0' ~ '07-SRAG-8.0',
    SITE_ID == '02-WFREN_T12-0.2' ~ '02-WFREN_T12-0.2',
    SITE_ID == '02-TWTY-4.0' ~ '02-TWTY-4.0',
    TRUE ~ SITE_ID
  )
  ) %>% 
...
```{r sample completeness check}

# join with project list for names and count samples and presence of QC (mainly to ensure each project or routine team has sufficient QC samples)
