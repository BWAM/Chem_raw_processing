...
output.filename <- paste0("2017_chem_preqaqc_ALL-SMAS_complete_", Sys.Date(), ".csv")
output.sample.filename <- paste0("2017_chem_preqaqc_SAMPLE-SMAS_complete_", Sys.Date(), ".csv")
output.result.filename <- paste0("2017_chem_preqaqc_RESULT-SMAS_complete_", Sys.Date(), ".csv")
